---
name: yogahub
description: Full brand, copy, and design standards for yogahub. Read this + builderbee/SKILL.md before every yogahub task.
---

# yogahub — Client Skill

**Type**: Multi-location yoga and pilates studio group, Ireland
**Locations**: Multiple Dublin studios + Sligo
**Website**: yogahub.ie
**Programmes**: Yoga Teacher Training, Mat Pilates TT, Reformer Pilates TT, Barre TT
...
| Programme | Deposit | Full Price | Instalment |
|-----------|---------|------------|------------|
| Yoga TT | £500 | Confirm with client | 3 × instalments |
| Mat Pilates TT | £500 | Confirm with client | 3 × instalments |
